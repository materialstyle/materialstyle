...
const distFolder = `materialstyle-${pkg.version}-examples`
const rootDocsDir = '_site'
const docsDir = `${rootDocsDir}/docs/${versionShort}/`

// these are the files we need in the examples
const cssFiles = [
  'materialstyle.min.css',
  'materialstyle.min.css.map',
  'materialstyle.rtl.min.css',
  'materialstyle.rtl.min.css.map'
]
const jsFiles = [
  'materialstyle.bundle.min.js',
  'materialstyle.bundle.min.js.map'
]
const imgFiles = [
  'materialstyle-logo.svg',
  'materialstyle-logo-white.svg'
]
