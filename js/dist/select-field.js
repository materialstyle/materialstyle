/*!
  * Material Style select-field.js v3.0.0 (https://materialstyle.github.io/)
  * Copyright 2018-2022 Neeraj Kumar Das (https://github.com/nkdas91)
  * Licensed under MIT (https://github.com/materialstyle/materialstyle/blob/master/LICENSE)  
  * This a fork of Bootstrap: Initial license below
  * 
  * Bootstrap select-field.js v5.2.0 (https://getbootstrap.com/)
  * Copyright 2011-2022 The Bootstrap Authors (https://github.com/twbs/bootstrap/graphs/contributors)
  * Licensed under MIT (https://github.com/twbs/bootstrap/blob/main/LICENSE)
  */
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('./util/color'), require('./base-component'), require('./dom/event-handler'), require('./dropdown'), require('./util/index')) :
...
})(this, (function (color, BaseComponent, EventHandler, Dropdown, index) { 'use strict';
  ...
  class SelectField extends BaseComponent__default.default {
    constructor(element) {
      super(element);
    ...
    createDropdown() {
      ...
      this._dropdownInstance = Dropdown__default.default.getOrCreateInstance(this._selectedItem);
    }
    ...
    showSelectedItems() {
      if (this._multiSelectEnabled) {
        ...
        for (const [, value] of Object.entries(closeButton)) {
          EventHandler__default.default.on(value, EVENT_CLICK, event => {
    ...
    _setListeners() {
      EventHandler__default.default.on(this._selectedItem, EVENT_FOCUS, () => this._dropdown.classList.add('float'));
      EventHandler__default.default.on(this._selectedItem, EVENT_FOCUSOUT, () => this.handleFocusOut());
      EventHandler__default.default.on(this._dropdown, EVENT_SHOWN, () => this._dropdown.classList.add('float'));
      EventHandler__default.default.on(this._dropdown, EVENT_HIDDEN, () => this.handleFocusOut());
      EventHandler__default.default.on(this._dropdown.querySelector(SELECTOR_SELECT_ALL), EVENT_CLICK, event => {
      ...
      EventHandler__default.default.on(this._dropdown.querySelector('.search-input'), EVENT_KEYUP, event => {
        this.search(event.target.value);
      });
      EventHandler__default.default.on(this._dropdown.querySelector('.search-input'), 'search', event => {
        this.search(event.target.value);
      });
      ...
      if (this._closeButton !== undefined) {
        EventHandler__default.default.on(this._closeButton, EVENT_CLICK, () => {
          this._dropdownInstance.toggle();
        });
      }

      EventHandler__default.default.on(this._select, 'change', event => {
        if (this._multiSelectEnabled) {
  ...
  index.defineJQueryPlugin(SelectField);
