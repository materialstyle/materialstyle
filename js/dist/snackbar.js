...
class Snackbar {
  ...
  addEventListeners() {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this._element).on('click', event => {
      event.stopImmediatePropagation();
      waitingQueue.pushToWaitingQueue(jquery__WEBPACK_IMPORTED_MODULE_0___default()(this._snackbar));
    });
  }
}
...
jquery__WEBPACK_IMPORTED_MODULE_0___default.a.fn[NAME] = Snackbar._jQueryInterface;
jquery__WEBPACK_IMPORTED_MODULE_0___default.a.fn[NAME].Constructor = Snackbar;
