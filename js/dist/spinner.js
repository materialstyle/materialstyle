...
class Spinner {
  ...
  initSpinner() {
    this._element.innerHTML = '<div class="animate-loader">' + '<svg class="circular" viewBox="25 25 50 50">' + '<circle class="path" cx="50" cy="50" r="20" fill="none" stroke-width="4">' + '</svg>' + '</div>';
  }
}
...
jquery__WEBPACK_IMPORTED_MODULE_0___default.a.fn[NAME] = Spinner._jQueryInterface;
jquery__WEBPACK_IMPORTED_MODULE_0___default.a.fn[NAME].Constructor = Spinner;
