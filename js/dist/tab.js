...
/* harmony import */ var bootstrap_js_dist_tab__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(26);
  ...
  static _jQueryInterface(config) {
    return this.each(function () {
      ...
      if (!data) {
        ...
        jquery__WEBPACK_IMPORTED_MODULE_1___default()(data._element).find('.nav-item').on('mousedown, mouseup', function () {
...
jquery__WEBPACK_IMPORTED_MODULE_1___default.a.fn[NAME] = Tab._jQueryInterface;
jquery__WEBPACK_IMPORTED_MODULE_1___default.a.fn[NAME].Constructor = Tab;
